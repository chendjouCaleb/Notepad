export class KeyboardCode {
  ...
  public static ShiftLeft = 'ShiftLeft';
  public static ShiftRight = 'ShiftRight';
  public static Tab = 'Tab';
  public static ControlLeft = 'ControlLeft';
  public static ControlRight = 'ControlRight';

  public static AltLeft = 'AltLeft';
  public static AltRight = 'AltRight';
